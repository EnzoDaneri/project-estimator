var app = (function () {
    ...
    // (54:1) {#each materials as material (material.id)}
    ...
    function create_fragment(ctx) {
    	...
    	let t9;
    	let td1;
    	let t10_value = /*formatter*/ ctx[3].format(/*total*/ ctx[1]) + "";
    	let t10;
    	...
    	return {
    		c() {
    			...
    			thead.innerHTML = `<tr class="svelte-j241cd"><th>Material</th> 
     <th>Price</th> 
     <th></th></tr>`;
    			...
    			t10 = text(t10_value);
    			attr(td1, "colspan", "2");
    			attr(tr1, "class", "svelte-j241cd");
    			attr(table, "class", "primary svelte-j241cd");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*total*/ 2) set_data(t0, /*total*/ ctx[1]);
    			...
    			if (dirty & /*total*/ 2 && t10_value !== (t10_value = /*formatter*/ ctx[3].format(/*total*/ ctx[1]) + "")) set_data(t10, t10_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "float-right svelte-naxrqr");
    		},
    		m(target, anchor) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const submit = () => {
    		...
    		$$invalidate(2, inputPrice.value = price, inputPrice); //esto es agregado para salvar un bug de svelte en esa versión y no actualizaba el valor en el input
    		$$invalidate(0, name = "");
